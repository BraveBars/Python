...
# Автопробег. За день машина проезжает N километров.
...
# Проверка на делимость. Выведите "YES", если A кратно B и "NO" в противном случае.
a = int(input())
b = int(input())
x = 0**(a%b)
print('YES'*x,'NO'*(0**x), sep='')

# Следующее четное. Дано целое число N.
# Выведите следующее за ним четное число.
n = int(input())
a = n % 2
print(n + 2 - a)

# Улитка*. Улитка ползет по вертикальному шесту высотой H метров,
